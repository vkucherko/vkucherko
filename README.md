...
<p align="center">
  <img src="./assets/hero-v7.svg" width="100%" alt="Terminal — slav@quality-engineer runs an agentic QA pipeline (story → design → generate → run → heal → green). AI Quality Engineer · 9+ yrs." />
</p>

<h3 align="center">I build quality systems for software and, increasingly, with AI.</h3>

<p align="center">Agentic testing that designs, verifies, executes, and self-heals end-to-end suites. From a story or knowledge base to an executed trustworthy build.</p>
...
<p align="center">
  <a href="#build"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/ui/navbtn-build-v4.dark.svg" /><img src="assets/ui/navbtn-build-v4.svg" height="36" alt="What I build" /></picture></a>
  <a href="#headed"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/ui/navbtn-headed-v4.dark.svg" /><img src="assets/ui/navbtn-headed-v4.svg" height="36" alt="Where I'm headed" /></picture></a>
  <a href="#impact"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/ui/navbtn-impact-v4.dark.svg" /><img src="assets/ui/navbtn-impact-v4.svg" height="36" alt="Impact" /></picture></a>
  <a href="#featured"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/ui/navbtn-featured-v4.dark.svg" /><img src="assets/ui/navbtn-featured-v4.svg" height="36" alt="Featured work" /></picture></a>
  <a href="#stack"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/ui/navbtn-stack-v4.dark.svg" /><img src="assets/ui/navbtn-stack-v4.svg" height="36" alt="Tech Stack" /></picture></a>
  <a href="#talk"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/ui/navbtn-talk-v4.dark.svg" /><img src="assets/ui/navbtn-talk-v4.svg" height="36" alt="Contact" /></picture></a>
</p>

<a id="build"></a>

<details>
<summary><h2>&nbsp;&nbsp;<picture><source media="(prefers-color-scheme: dark)" srcset="assets/glyph/build.dark.svg" /><img src="assets/glyph/build.svg" height="28" align="absmiddle" alt="" /></picture>&nbsp;&nbsp;What I Build Now</h2></summary>
...
<details>
<summary><h2>&nbsp;&nbsp;<picture><source media="(prefers-color-scheme: dark)" srcset="assets/glyph/headed.dark.svg" /><img src="assets/glyph/headed.svg" height="28" align="absmiddle" alt="" /></picture>&nbsp;&nbsp;Where I'm headed</h2></summary>
...
<details>
<summary><h2>&nbsp;&nbsp;<picture><source media="(prefers-color-scheme: dark)" srcset="assets/glyph/optimize.dark.svg" /><img src="assets/glyph/optimize.svg" height="28" align="absmiddle" alt="" /></picture>&nbsp;&nbsp;What I optimize for</h2></summary>
...
## <picture><source media="(prefers-color-scheme: dark)" srcset="assets/glyph/featured.dark.svg" /><img src="assets/glyph/featured.svg" height="28" align="absmiddle" alt=""></picture> &nbsp;Featured work
...
flowchart TD
    US["Azure DevOps user story"] --> DES["Design agent"]
    DES --> GEN["Generate: Playwright + TypeScript"]
    GEN --> VER["Verify selectors in a real browser"]
    VER --> RUN["Execute suite"]
    RUN -->|pass| REP["Report + Allure"]
    RUN -->|fail| HEAL["Self-heal agent"]
    HEAL -->|confidence >= bar| GEN
...
```mermaid
flowchart TD
    Scan["Scan barcode (expo-camera)"] --> Cache{"MMKV to SQLite: cache hit?"}
    Cache -->|hit, offline| Eval["HealthEvaluator: 65-rule engine"]
    Cache -->|miss| Worker["Cloudflare Worker (Hono)"]
    Worker --> DB[("Supabase: OFF + USDA + community")]
    DB --> Worker
    Worker --> Eval
...
<sub>React Native · Expo · TypeScript · Cloudflare Workers · Supabase / Postgres · Claude / Claude Code &nbsp;·&nbsp; source private · TestFlight on request</sub>

<a id="stack"></a>

<details>
<summary><h2>&nbsp;&nbsp;<picture><source media="(prefers-color-scheme: dark)" srcset="assets/icons/layers-dark.svg" /><img src="assets/icons/layers-v2.svg" height="28" align="absmiddle" alt="" /></picture>&nbsp;&nbsp;Tech Stack</h2></summary>

<br />

<p align="center">
  <img src="https://skillicons.dev/icons?i=ts,js,java,python,selenium&perline=15" height="48" align="absmiddle" alt="TypeScript, JavaScript, Java, Python, Selenium" />
  &nbsp;<img src="assets/ui/playwright.svg" height="48" align="absmiddle" alt="Playwright" />&nbsp;
  <img src="https://skillicons.dev/icons?i=nodejs,react,githubactions,jenkins,azure,aws,cloudflare,supabase,postgres&perline=15" height="48" align="absmiddle" alt="Node.js, React, GitHub Actions, Jenkins, Azure, AWS, Cloudflare, Supabase, Postgres" />
</p>

|  |  |
| --- | --- |
| **Test automation** | Playwright · Selenium · REST / API · Page Object Model · ReadyAPI · Postman |
| **AI & agents** | Multi-agent orchestration · Claude · MCP · tool-calling · RAG · self-healing loops · multi-model review panel · task-aware model selection · eval harnesses |
...
## <picture><source media="(prefers-color-scheme: dark)" srcset="assets/glyph/talk.dark.svg" /><img src="assets/glyph/talk.svg" height="28" align="absmiddle" alt=""></picture> &nbsp;Let's talk

<p align="center">
  <img src="./assets/sig.svg" width="150" alt="SK monogram" />
</p>

<p align="center"><em>Currently exploring how agentic AI changes what a single quality engineer can own.</em></p>
